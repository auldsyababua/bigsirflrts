...
agent, tell the user to check the .bmad-infrastructure-devops/checklists folder
to select the appropriate one to run.
...
1. **Initial Assessment**
   - If user or the task being run provides a checklist name:
     ...
     - Load the appropriate checklist from
       .bmad-infrastructure-devops/checklists/
